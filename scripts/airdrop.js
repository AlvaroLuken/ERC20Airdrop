...
const contractJson = require("../artifacts/contracts/GoofyGoober.sol/GoofyGoober.json");

const tokenAddress = "0x7869dfa4dbA2AEe883A28D50f948b6061F9a0186";
...
async function main() {
  ...
  for(let i = 0; i < addresses.length; i++) {
    let tx = await contractInstance.transfer(addresses[i], ethers.utils.parseEther("22"));
